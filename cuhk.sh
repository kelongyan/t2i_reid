#!/bin/bash
# ============================================================================
# CUHK-PEDES Training Protocol | Optimized Configuration
# ============================================================================
# Model:    AH-Net + S-CAG/RCSM Fusion + Adversarial Disentanglement
# Backbone: CLIP-ViT-B/16 + Vim-S (Vision Mamba)
# Dataset:  CUHK-PEDES (11,003 identities)
# Strategy: 3-Phase Curriculum Learning (20-50-100 epochs)
# 
# Key Optimizations:
# - LR: 0.00005 (lower for Vim+CLIP stability)
# - Epochs: 100 (sufficient for disentanglement convergence)
# - Batch: 128 (better for contrastive learning)
# - Warmup: 2000 steps (Vim initialization stability)
# - Loss Weights: Balanced for 3-phase curriculum
# ============================================================================

export OMP_NUM_THREADS=4
export CUDA_DEVICE_ORDER=PCI_BUS_ID

LOG_DIR="log/cuhk_pedes"
mkdir -p "$LOG_DIR/model" "$LOG_DIR/vis"

echo "================================================================================"
echo "🚀 CUHK-PEDES Training | Optimized Protocol"
echo "================================================================================"
...
echo "  ⚡ LR:            0.00005 (Optimized for Vim+CLIP)"
echo "  📦 Batch Size:    128"
echo "================================================================================"
...
DATASET_CONFIG="[{'name': 'CUHK-PEDES', 'root': 'CUHK-PEDES', 'json_file': 'CUHK-PEDES/annotations/captions_all.json'}]"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ CUHK-PEDES Training Completed Successfully"
    echo "   Results:  ${LOG_DIR}/res.txt"
    echo "   Best Model: ${LOG_DIR}/model/best_cuhk_pedes.pth"
