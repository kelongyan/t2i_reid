...
# ============================================================================
# ICFG-PEDES Training Script - Updated Version
# ============================================================================
...
echo "Parameter override examples: bash icfg.sh --disentangle-type=simple --no-viz"
echo ""
...
# FSHD/AH-Net configuration parameters (ICFG uses more attention heads due to larger dataset)
CMD="$CMD \
    --gs3-num-heads 12 \
    --gs3-d-state 16 \
    --gs3-d-conv 4 \
...
if [ "$ENABLE_VISUALIZATION" = true ]; then
    ...
    echo "✓ Visualization: enabled (visualizations/icfg_${DISENTANGLE_TYPE})"
else
...
echo "Note: ICFG dataset is larger, using 12 attention heads"
...
if [ $exit_code -eq 0 ]; then
    echo "=========================================="
    echo "✅ ICFG-PEDES Training completed!"
    echo "=========================================="
else
    echo "=========================================="
