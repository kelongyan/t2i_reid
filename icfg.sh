#!/bin/bash
# ============================================================================
# ICFG-PEDES Training Protocol | Stage: Deployment
# ============================================================================
# Project:  Text-Image ReID with State-Space Models (Mamba)
# Dataset:  ICFG-PEDES (Identity-Centric Fine-Grained)
...
LOG_DIR="log/icfg_pedes/${TIMESTAMP}"
mkdir -p "$LOG_DIR"

echo "================================================================================"
echo "🚀 Initiating Training Protocol: ICFG-PEDES"
echo "================================================================================"
